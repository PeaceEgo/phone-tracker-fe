        ...
        <div className="min-h-screen text-white flex items-center justify-center relative">
            ...
            <div className="w-full max-w-md p-8 relative z-10">
                ...
                <div className="bg-pink-600 p-6 rounded-lg shadow-lg">
                    ...
                    <p className="text-center text-gray-200 mb-6">Enter your credentials to access your account.</p>
                    <input
                        type="email"
                        placeholder="Email"
                ...
                <div className="text-center mt-4 text-sm text-gray-400">
                    <p>Don't have account yet? <a href="/auth/signup" className="text-purple-400 hover:underline">Sign Up</a></p>
                </div>
                <div className="text-center mt-4 text-sm text-gray-400">
