  ...
  const renderRegisterContent = () => (
    <div className="space-y-6"> 
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold text-white mb-2">Register New Device</h2>
        <p className="text-gray-400">Add a new device to start tracking its location</p>
      </div>
      ...
      <div className="space-y-4">
        <div>
          <Label htmlFor="deviceName" className="text-gray-300 mb-6">Device Name *</Label>
          <Input
            id="deviceName"
            value={deviceName}
            onChange={(e) => setDeviceName(e.target.value)}
            placeholder="e.g., My iPhone"
            className="bg-slate-800/50 border-slate-600/50 text-white placeholder:text-gray-500"
            disabled={isRegistering}
          />
        </div>

        <div>
          <Label htmlFor="deviceType" className="text-gray-300 mb-6">Device Type *</Label>
          <Select 
            value={deviceType} 
        ...
        <div>
          <Label htmlFor="locationName" className="text-gray-300 mb-6">
            Location Name 
        ...
        <Button
          ...
          className="w-full border-blue-500/30 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 disabled:opacity-50"
        >
        ...
        {currentLocation && (
          <div className="p-3 bg-green-500/20 border border-green-500/30 rounded-lg">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-green-300 text-sm font-medium">Location Captured</span>
            </div>
  ...
  const renderHistoryContent = () => (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold text-white mb-2">Location History</h2>
        <p className="text-gray-400">View past locations for your devices</p>
      </div>
        ...
        <div className="space-y-3">
          {devices.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-500 text-sm">Register a device first to view location history</p>
            </div>
          ) : (
            <>
              <p className="text-gray-400 text-center">Select a device to view its location history:</p>
              {devices.map((device) => (
                <motion.div
                  key={device.deviceId}
                ...
                >
                  <Button
                    ...
                    className="w-full p-4 h-auto border-slate-600/50 text-white hover:bg-slate-700/50 bg-slate-800/50 disabled:opacity-50"
                  >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="text-left">
                          ...
                          <div className="text-sm text-gray-400 flex items-center">
                            <Badge 
                              className={`mr-2 ${device.isOnline 
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center gap-2 text-gray-400">
                <Badge 
                  className={selectedDevice.isOnline 
                    ? "bg-green-500/20 text-green-300 border-green-500/30" 
                    : "bg-gray-500/20 text-gray-400 border-gray-500/30"
                  }
                >
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              className="border-slate-600/50 text-white hover:bg-slate-700/50 bg-slate-800/50"
              disabled={historyLoading}
            >
              Back to Devices
            </Button>
          ...
          {historyLoading ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-400">Loading location history...</p>
            </div>
            ...
            <div className="max-h-96 overflow-y-auto space-y-3">
              {locationHistory.map((entry) => (
                <div
                  key={entry._id}
                  className="p-4 bg-slate-800/30 rounded-lg border border-slate-600/30 hover:bg-slate-700/30 transition-colors"
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
